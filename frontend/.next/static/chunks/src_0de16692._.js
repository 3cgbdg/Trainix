...
"[project]/src/app/(auth)/auth/signup/page.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const loginUser = async (data)=>{
    const res = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$api$2f$axiosInstance$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["api"].post("/api/auth/signup", data);
    return res.data;
};
const Page = ()=>{
    _s();
...
_s(Page, "onZXwFkB1CYDLCmlS3jt6d+tAA0=", false, function() {
    return [
...
//# sourceMappingURL=src_0de16692._.js.map