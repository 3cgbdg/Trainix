...
const onboardingFunc = async (data)=>{
    const res = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post("/api/onboarding", data);
    return res.data;
};
const Page = ()=>{
    _s();
...
_s(Page, "E3RrhnEsM7VciWmBlAA1mLoZOJU=", false, function() {
    return [
...
//# sourceMappingURL=src_app_%28main%29_onboarding_page_tsx_b3aecc58._.js.map