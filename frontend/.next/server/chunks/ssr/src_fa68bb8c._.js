...
const Page = ()=>{
    ...
    const mutation = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useMutation$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMutation"])({
        ...
        onSuccess: async (data)=>{
            setIsAnalyzed(true);
            try {
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$report$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["reportExtractFunc"])(data.AIreport);
                console.log("dasd");
            } catch (err) {
                console.error(err);
            }
