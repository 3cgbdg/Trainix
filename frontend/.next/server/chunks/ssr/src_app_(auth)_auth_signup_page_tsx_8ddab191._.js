...
const loginUser = async (data)=>{
    const res = await api.post(`${("TURBOPACK compile-time value", "http://localhost:5200")}/api/auth/signup`, data, {
...
//# sourceMappingURL=src_app_%28auth%29_auth_signup_page_tsx_8ddab191._.js.map