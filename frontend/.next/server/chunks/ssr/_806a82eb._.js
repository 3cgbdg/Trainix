...
const page = ()=>{
    ...
    const getNumbers = async ()=>{
        const res = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$api$2f$axiosInstance$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["api"].post(`api/fitness-plan/reports/numbers`, {
            date: new Date()
        });
        return res.data;
    };
...
//# sourceMappingURL=_806a82eb._.js.map