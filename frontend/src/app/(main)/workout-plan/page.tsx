        ...
        <div className='flex flex-col gap-6'>
            ...
            <div className=" _workout-plan-banner py-1 px-8  h-60 flex items-center  justify-between  ">
                <div className="flex flex-col gap-3">
                    ...
                    <Link className="button-green max-w-[182px] w-full" href={`/workout/${data?.todayWorkoutNumber+1}`}>Start Today's Workout</Link>
                </div>
            </div>
            ...
            <div className="flex flex-col gap-4 ">
                ...
                <div className="grid grid-cols-4 gap-6">
                    {isSuccess &&
                        data.workouts.map(( item: IDayPlan,idx: number) => (
                            <div key={idx} className=" p-4 pt-5.5 bg-white rounded-md _border ">
                                <div className="flex items-center justify-between mb-8 ">
                                    <div className="flex items-center gap-2">
                                        ...
                                        <span className={`text-lg leading-7 font-semibold`}>{data.dates[idx].weekDay }</span>
                                    </div>
                                ...
                                <div className="flex flex-col gap-2 mb-9">
                                    <span className="text-sm leading-5">{data.dates[idx].monthAndDate}</span>
